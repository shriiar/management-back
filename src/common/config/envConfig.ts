...
export default <() => Record<EnvVariables, string | number>>(() => ({
	...
	CARDKNOX_KEY: process.env.CARDKNOX_KEY,
	CARDKNOX_SOFTWARE_NAME: process.env.CARDKNOX_SOFTWARE_NAME,
	CARDKNOX_SOFTWARE_VERSION: process.env.CARDKNOX_SOFTWARE_VERSION,
}));